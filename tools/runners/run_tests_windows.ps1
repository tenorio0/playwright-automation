...
Write-Host ""
Write-Host "QA Automation Test Runner" -ForegroundColor Cyan
...
if ($Target -and $Target.Trim()) {
    ...
    Write-Host "Running automation/testng.xml ..." -ForegroundColor Yellow
    & $venvPython -B automation\run_testng.py
}
